...
const MainDisplay: React.FC = () => {
  return (
    <View style={styles.mainScene}>
      <Text style={styles.mainTitle}>{"Sales Landing Page"}</Text>
      ...
      <View style={styles.listScene}>
        <List>
          ...
          >
            ...
            <ListItemText
              style={styles2.listItemText}
            >{`(Proposal) Go Above Marketing: Reviewed and improved proposal to close an eCommerce client `}</ListItemText>
          </ListItem>
        </List>
      </View>
    </View>
